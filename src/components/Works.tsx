          ...
          >
            ...
            <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-center text-left relative z-10">
              ...
              <div className="flex flex-col gap-3 md:gap-4 py-2">
                ...
                <a 
                  href="https://www.youtube.com/watch?v=12oEGg8b6qk"
                  target="_blank"
                  rel="noreferrer"
            ...
            {projects.map((project, i) => (
              ...
              >
                <div 
                  ...
                  className="group flex flex-col h-full bg-white rounded-[2rem] md:rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-200 group/card cursor-pointer"
                >
                  {/* Image Container */}
                  <div 
                    className="aspect-video w-full overflow-hidden relative bg-slate-100"
                  >
                  ...
                  <div className="p-6 md:p-8 flex flex-col gap-4 relative text-left flex-grow">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <a 
                        ...
                        className="w-10 h-10 shrink-0 rounded-full bg-slate-50 flex items-center justify-center hover:bg-brand-dark hover:text-white hover:scale-110 transition-all duration-300 border border-slate-100 shadow-sm"
                        title="Open App"
                      >
